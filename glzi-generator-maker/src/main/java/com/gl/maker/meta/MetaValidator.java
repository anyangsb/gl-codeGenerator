...
import com.gl.maker.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "gl");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.gl");
